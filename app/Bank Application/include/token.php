...
/**
 * @param string $username  Login user's userid
 * 
...
function generate_token($userid) {
	if ($userid == 'admin'){
    	...
    	return JWT::generate_token($userid, SECRET_KEY_ADMIN);
    }
 ...
 * 
 * @return mixed  If verified, return string userid.  Else return boolean false.
 */
