        ...
        <script>
            ...
            input.addEventListener("input", async function(){
                ...
                const responseFetch =  await fetch (
                  'https://api.cs301-g7.com/loyaltyprogram/convertCurrencies',
                  {
                    // mode: 'cors',
                    method: 'POST',
                ...
                document.getElementById("error_miles").innerHTML = "<br><p style = color:red;>" + response["errorMilesMessage"] + "</p>";
                document.getElementById("convertedPoints").innerHTML = "<p>" + response["convertedPointsMessage"] + "</p>";
                document.getElementById("status").value = response["status"];
                document.getElementById("points").value = points;
                document.getElementById("convertedPoint").value = response["convertedPoints"];
