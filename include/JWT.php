...
class JWT
{
	...
	// addition functions
	/**
	 * Returns a JSON web token based on the $userid and $secret_key.
	 * 
	 ...
	 */
	public static function generate_token($userid, $secret_key) {
		$token_arr = [ 'userid' => $userid,  'datetime' => date('Y-m-d H:i:s')];
