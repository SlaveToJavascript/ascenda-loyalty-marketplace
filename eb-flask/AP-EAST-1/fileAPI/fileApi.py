...
CORS(app)
validationURL = "https://aljzpgguk3.execute-api.ap-east-1.amazonaws.com/production/validation/"
EXTENSION = ".txt"

all_partner_codes = requests.get("https://aljzpgguk3.execute-api.ap-east-1.amazonaws.com/production/loyaltyprogram/partnercodes", headers={"X-API-KEY": "bv34XeV2TN1ta2ZAuTXlqU5eA0piseRBbHJCXih0"})
